...
class product_pack(models.Model):
    ...
    parent_product_id = fields.Many2one('product.product', string='Parent Product', ondelete='cascade', required=True)
    ...
    def get_sale_order_line_vals(self, line, order):
        ...
        if line.product_id.pack_price_type in [
            ...
            price = pricelist.price_get(subproduct.id, quantity, order.partner_id)[pricelist.id]
